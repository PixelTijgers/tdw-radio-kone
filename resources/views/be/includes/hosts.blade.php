<div class="flex flex-col" id="hosts">
    ...
    <div class="lg:flex">
        ...
        <div class="lg:w-8/12 -mt-10 ml-10">
            ...
            <p class="lg:text-lg text-right lg:text-left">Bert van Steenberghe is radiopresentator bij Studio Brussel. Hij kan z’n kennis en passie voor muziek ook kwijt als DJ. Zijn stem leent hij dan weer regelmatig uit voor spots en aankondigingen op VRT. Bert is niet zomaar een presentator, meer een radiomaker. </p>
    ...
    <div class="lg:flex flex-row-reverse mt-10">
        ...
        <div class="lg:w-8/12 -mt-10 mr-10">
            ...
            <p class="lg:text-lg text-right lg:text-left">Aurore Schottey Picavet is radiopresentatrice en actrice voor theater, film en televisie. Ze is ook actief als voice-over artieste. Ze spreekt vijf talen: Frans, Nederlands, Duits, Engels en Spaans. Ze is moeder, speelt viool en bekommert zich om duurzaamheid. </p>
