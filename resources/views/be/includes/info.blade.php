<div class="flex flex-row mt-16 md:mt-10" id="info">

    <div class="md:w-9/12">

        <h3 class="text-4xl mb-5">Info</h3>
        ...
        <p>Muziek verbindt ons allemaal en radio kent geen grenzen, dus waar je ook bent: thuis, onderweg, op kantoor of op de werf? Luisteren kan je van overal. Op veilige fysieke afstand van elkaar, maar toch zo dichtbij! <strong>#OneKONEteam</strong></p>

    </div>

    <div class="hidden md:flex md:w-3/12 md:mt-15">

        <figure>

            <img src="{{ asset('img/muzieknootjes.png') }}" alt="Muzieknootjes" />
